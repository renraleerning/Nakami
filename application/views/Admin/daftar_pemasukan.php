<div class="col-span-5">
			<div class="flex flex-between">
				<a class="mt-2 text-center font-bold text-lg py-2 px-2 w-40 bg-[#919191] border-2 border-black rounded-xl" href="<?php echo site_url('Admin/form_tambah_pemasukan') ?>">Tambah Entri</a>	
			...
			<table border="1" class="bg-[#919191] w-full border-2 rounded border-black mt-[9px]">
				<tr>
					...
					<th class="text-lg">Nama Pemesanan</th>
					<th class="text-lg">Harga</th>
					<th class="text-lg">qty</th>
					<th class="text-lg">Total</th>
					<th class="text-lg w-48">Bukti Transfer</th>
				...
				foreach ($pemasukan as $key) {
					...
					<tr>
						...
						<td class="border-2 border-black pl-2"><?php if ($key->bukti_transfer==null) {
							echo "-";
						}else{
							?>
							<center>
						...
						<td class="border-2 border-black w-36">
							<a class="ml-[5px] text-center font-bold text-lg px-2 bg-[green] hover:bg-white border-2 border-black rounded-xl" href="<?php echo site_url('Admin/edit_pemasukan/').$key->id ?>">edit</a>
							<a class=" text-center font-bold text-lg px-2 bg-[red] hover:bg-white border-2 border-black rounded-xl" href="<?php echo site_url('Admin/hapus_pemasukan/').$key->id ?>">delete</a>
						</td>
					</tr>
					<?php
				}
...
<div id="modal<?php echo $key->id ?>" class="fixed hidden z-50 inset-0 bg-gray-900 bg-opacity-60 overflow-y-auto h-full w-full px-4 modal<?php echo $key->id; ?>">
    <div class="relative top-20 mx-auto shadow-xl rounded-md bg-white max-w-md">
        ...
        <div class="max-h-[500px] overflow-y-scroll p-4">
            ...
            <img src="<?php echo base_url('Aset/bukti/').$key->bukti_transfer ?>">
        </div>
