...
<div class="container mx-auto">
	...
	<center>
		...
		<form class="bg-white shadow-md rounded px-8 pt-2 pb-8 mb-4" action="<?php echo site_url('Admin/update_pengeluaran') ?>" method="post" enctype="multipart/form-data">
			  ...
			  <div class="md:flex md:items-center mb-6">
			    ...
			    <div class="md:w-2/3">
			      <input class="bg-gray-200 appearance-none border-2 border-gray-200 rounded w-full py-2 px-4 text-gray-700 leading-tight focus:outline-none focus:bg-white focus:border-gray-500" id="inline-full-name" type="file" name="bukti_struk" value="<?php echo $key->bukti_struk?>">
			    </div>
			  </div>
