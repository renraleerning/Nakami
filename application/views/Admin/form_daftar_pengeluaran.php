	...
	<center>
		...
		<form class="bg-white shadow-md rounded px-8 pt-2 pb-8 mb-4" action="<?php echo site_url('Admin/tambah_pengeluaran') ?>" method="post" enctype="multipart/form-data">
		    ...
		    <div>
		      ...
		      <br>
		      <br>
		      <a class="bg-red-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline" href="<?php echo site_url('Admin/daftar_pengeluaran') ?>">batal</a>
		    </div>
		  </form>
	</center>
</div>	