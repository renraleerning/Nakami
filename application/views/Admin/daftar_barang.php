				...
				foreach ($barang as $key) {
					...
					<tr>
						...
						<td class="border-2 border-black w-36">
							<a class="ml-[5px] text-center font-bold text-lg px-2 bg-[green] hover:bg-white border-2 border-black rounded-xl" href="<?php echo site_url('Admin/edit_daftar_barang/').$key->id ?>">edit</a>
							<a class=" text-center font-bold text-lg px-2 bg-[red] hover:bg-white border-2 border-black rounded-xl" href="<?php echo site_url('Admin/hapus_barang/').$key->id ?>">delete</a>
						</td>
					</tr>
					<?php
				}
